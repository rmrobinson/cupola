...
- The `imap` dispatcher (Phase 23/24) is not yet implemented. When it is, it will require outbound access to an IMAP server, which may be local or internet-hosted depending on the mail provider.
