...
var widgetImportRegistry = map[string]widgetImportMeta{
	...
	"weather-pollen-current":  {Domains: []domain.DomainType{domain.DomainWeatherPollen}},
	"weather-pollen-forecast": {Domains: []domain.DomainType{domain.DomainWeatherPollen}},
